# Use cases:
# - Intraday opening-range breakout research on NIFTY-like instruments.
# - Reference implementation for day strategies with custom trailing-stop hooks.
"""
