...
class OpenPosition:
    ...
    def __post_init__(self) -> None:
        # P3 FIX: OpenPosition is dead code — emit warning on instantiation
        warnings.warn(
            "backtester.trade_log.OpenPosition is dead code — "
            "use backtester.models.Position instead. "
            "OpenPosition is not used by the backtester engine and will "
